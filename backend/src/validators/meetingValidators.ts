...
export const createMeetingSchema = z
  .object({
    ...
    startTime: z
      .string()
      .datetime({ message: "Invalid start time format (ISO 8601 required)" }),
    endTime: z
      .string()
      .datetime({ message: "Invalid end time format (ISO 8601 required)" }),
    address: z
      .string()
...
export const doubleBookingCheckSchema = z
  .object({
    startTime: z
      .string()
      .datetime({ message: "Invalid start time format (ISO 8601 required)" }),
